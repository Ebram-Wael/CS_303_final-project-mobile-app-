...
<SafeAreaView style={styles.container}>
    <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Image style={{width:300 ,height:200 ,alignSelf:'center'}} source={city}/>
        <TextInput
        style={styles.input}
       ...
       <TextInput
        ...
        keyboardType="numeric"
        />
        {errorNumBedrooms && <Text style={styles.error}>{errorNumBedrooms}</Text>}
        ...
        <Pressable style={styles.btn} onPress={async () => await handleSubmit()}>
            <Text>
                ADD APARTMENT
            </Text>
        </Pressable>
