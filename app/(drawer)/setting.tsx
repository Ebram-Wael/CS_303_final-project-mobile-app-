  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={[styles.container, { backgroundColor: isDark ? Colors.darkModeBackground : Colors.background }]}>
        <Text style={[styles.head, { color: isDark ? Colors.whiteText : Colors.text }]}>Setting</Text>
        <Text style={[styles.text, { color: isDark ? Colors.whiteText : Colors.assestGray }]}>Preferences</Text>
        ...
        <Text style={[styles.text, { color: isDark ? Colors.whiteText : Colors.assestGray }]}>Help</Text>
        <View style={styles.block}>
          <Pressable
            onPress={() => router.push('../components/reportUs')}
        ...
        <Text style={[styles.text, { color: isDark ? Colors.whiteText : Colors.assestGray }]}>Privacy</Text>
        <View style={styles.block}>
