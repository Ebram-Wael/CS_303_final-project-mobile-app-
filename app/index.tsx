...
export default function index() {
  ...
  return (
    ...
    <ScrollView>
    <Text style={styles.head}>  Find the Perfect Apartment for Students</Text>
    <Image source={images[index]} style={{ width: 400, height: 400, marginBottom: 30 }} />

    <Text style={styles.h2}>
    Looking for a comfortable and affordable place to stay?
     Homy makes apartment hunting easy for students! Whether you need a shared space or a private room,
     we connect you with the best housing options near your university.
      </Text>
     ...
     <Text style={styles.h2}>Join thousands of students who found their perfect home with Homy.
       Sign up now and take the stress out of apartment hunting!</Text>
       <Pressable style={{display:'flex',alignItems:'center',justifyContent:'center',marginTop:20}} >
