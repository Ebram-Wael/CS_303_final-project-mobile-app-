    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.paragraph}>
          ...
          students find and rent rooms easily. Sellers can list available rooms
          for rent, while students can browse, view details, and book
          accommodations. The platform aims to simplify the housing search
          process and provide a user-friendly experience.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          Room Listings (Sellers can post available rooms with details and
          images) {"\n"}
          Search & Filters (Students can search for rooms based on location,
          price, and amenities) {"\n"}
